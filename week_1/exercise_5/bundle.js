...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Foo = __webpack_require__(186);

	var _Foo2 = _interopRequireDefault(_Foo);

	var _Bar = __webpack_require__(187);
	...
	// Set up store
	var store = (0, _redux.createStore)(reducer, (0, _redux.compose)((0, _redux.applyMiddleware)(reduxRouterMiddleware), window.devToolsExtension ? window.devToolsExtension() : function (f) {
	  return f;
	}));
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ onClick: function onClick() {
							return dispatch(_reactRouterRedux.routeActions.push('/'));
						} },
					'Home'
				),
				_react2.default.createElement(
					'li',
					{ onClick: function onClick() {
							return dispatch(_reactRouterRedux.routeActions.push('/foo'));
						} },
					'Foo'
				),
				_react2.default.createElement(
					'li',
					{ onClick: function onClick() {
							return dispatch(_reactRouterRedux.routeActions.push('/bar'));
						} },
					'Bar'
				)
			),
